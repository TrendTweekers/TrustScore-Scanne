...
const content = `import { CheckCircle2, XCircle } from "lucide-react";
...
fs.writeFileSync('frontend/components/ScoreBreakdown.jsx', content);
console.log('✅ Fixed ScoreBreakdown.jsx');